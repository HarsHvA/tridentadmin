...
class MobileEditMatch extends StatefulWidget {
  final String matchId;

  MobileEditMatch({Key key, @required this.matchId}) : super(key: key);
  @override
  _MobileEditMatchState createState() => _MobileEditMatchState(matchId);
}

class _MobileEditMatchState extends State<MobileEditMatch> {
  String matchId;
  _MobileEditMatchState(this.matchId);
